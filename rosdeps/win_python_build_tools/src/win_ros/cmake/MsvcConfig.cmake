...
set(BOOST_CXX_FLAGS "/DBOOST_ALL_NO_LIB /DBOOST_ALL_DYN_LINK /EHsc")
set(ROSDPES_CXX_FLAGS "-I${ROSDEPS_ROOT}/include")
# We use CMAKE_USER_MAKE_RULES_OVERRIDE to configure CMAKE_CXX_FLAGS_INIT ()
set(WINROS_CXX_FLAGS_INIT "${BOOST_CXX_FLAGS} ${ROSDEPS_CXX_FLAGS} /DWIN32" CACHE STRING "Initial flags that get passed to CMAKE_CXX_FLAGS via the cmake override file.")
